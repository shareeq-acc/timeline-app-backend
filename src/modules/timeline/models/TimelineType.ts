...
import { TimelineTypePartial, TimelineTypeProps } from '../types/timelineType.types';
import { mapDbRowToTimelineType, mapDbRowToTimelineTypePartial } from '../utils/timelineTypesMapper';

export class TimelineType implements TimelineTypeProps{
    id: string;
    type: string;
    description: string;
    needsTimeUnit: boolean = false;
    needsDuration: boolean = false;
    ...
    constructor(data: any) {
        ...
        this.needsTimeUnit = data.needsTimeUnit || false;
        this.needsDuration = data.needsDuration || false;
        this.supportsScheduling = data.supportsScheduling || false;
