import { TimelineResponseDto } from "../../Dtos/dtos";
import { TimelineDbRow } from "./timeline.types";
import { TimelineForkProps } from "../timelineFork/timelineFork.types";
import { TimelineTypePartial } from "../timelineTypes/timelineType.types";
import { TimeUnitDto } from "../timeUnit/timeUnit.types";
...
export const mapTimelineToResponseDto = (timeline: TimelineDbRow, timelineTypes:TimelineTypePartial, includeForkDetails: boolean = false, timeUnit:TimeUnitDto | null = null, forkDetails?: TimelineForkProps): TimelineResponseDto=> {
